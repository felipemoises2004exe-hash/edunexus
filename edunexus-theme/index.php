...
<head>
    ...
    <title>EduNexus - Plataforma Educativa</title>
    <!-- Fuentes e iconos -->
...
<body>
    ...
    <nav class="navbar">
        <div class="container">
            ...
            <ul class="nav-menu" id="navMenu">
                ...
                <li><a href="#" class="btn-primary">Ingresar</a></li>
            </ul>
    ...
    <footer class="footer">
        <div class="container">
            ...
            <div class="footer-bottom">
                &copy; 2025 EduNexus. Todos los derechos reservados.
            </div>
        </div>
    </footer>
    ...
    <script>
        ...
        // Cierra menú al hacer clic en un enlace (modo móvil)
